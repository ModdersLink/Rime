...
{
    public uint[] MipOffsets { get; set; } = new uint[2];
    ...
    public bool Serialize(RimeWriter p_Writer)
    {
        ...
        p_Writer.Write(MipOffsets[0]);
        p_Writer.Write(MipOffsets[1]);
        p_Writer.Write((uint)Type);
        p_Writer.Write((uint)Format);
        p_Writer.Write((ushort)Flags);
    ...
    public void Deserialize(RimeReader p_Reader)
    {
        ...
        MipOffsets[0] = p_Reader.ReadUInt32();
        MipOffsets[1] = p_Reader.ReadUInt32();
        ...
        Flags = (TextureFlags) p_Reader.ReadUInt16();
