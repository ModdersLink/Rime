	...
	: fb.Core.DataContainer
{
	...
	public UIWidgetEventID Query { get; set; } = UIWidgetEventID.UIWidgetEventID_None;
	
	[ContainerField(0x24), LayoutImmutable, Blittable, JsonProperty(Order = 36)]
	public bool AllowManualRemove { get; set; } = false;
	
	[ContainerField(0x25), LayoutImmutable, Blittable, JsonProperty(Order = 37)]
	public bool IsReferencePort { get; set; } = false;
	...
	public override void Serialize(RimeWriter p_Writer, IEbxWriter p_EbxWriter)
	{
		...
		p_Writer.Write(IsReferencePort);
