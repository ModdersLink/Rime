	...
	: fb.Entity.EntityData
{
	...
	public bool ActivateOnCreation { get; set; } = false;
	
	[ContainerField(0x21), LayoutImmutable, Blittable, JsonProperty(Order = 33)]
	public bool AccumulatedInputs { get; set; } = false;
	...
	public override void Serialize(RimeWriter p_Writer, IEbxWriter p_EbxWriter)
	{
		...
		p_Writer.Write(ActivateOnCreation);
		p_Writer.Write(AccumulatedInputs);
