	...
	: fb.Entity.GameComponentData
{
	...
	public LinearTransform TransformOverride { get; set; } = new()
	{
		trans = new()
		{
			z = 0.000f,
	...
	public bool UseTransformOverride { get; set; } = false;
	
	public override void Serialize(RimeWriter p_Writer, IEbxWriter p_EbxWriter)
	{
		base.Serialize(p_Writer, p_EbxWriter);
		TransformOverride.Serialize(p_Writer, p_EbxWriter);
		p_Writer.Write((int) Realm);
		p_Writer.Write(UseTransformOverride);
