...
public class LevolutionMessageEntityData
	: fb.Entity.EntityData
{
	...
	public LinearTransform WorldPosition { get; set; } = new()
	{
		trans = new()
		{
			z = 0.000f,
	...
	public override void Serialize(RimeWriter p_Writer, IEbxWriter p_EbxWriter)
	{
		...
		p_Writer.Write((int) LevolutionType);
		p_Writer.WriteNullBytes(4);
		p_Writer.Write(p_EbxWriter.WriteString(LevolutionId));
	}
}
