...
public class VehicleLightingComponentData
	: fb.Entity.VisualEnvironmentComponentData
{
	...
	public VehicleLightingMode VehicleLightingMode { get; set; } = fb.WorldRender.VehicleLightingMode.VehicleLightingMode_Add;
	...
	public bool VehicleLightEnable { get; set; } = false;
	...
	public override void Serialize(RimeWriter p_Writer, IEbxWriter p_EbxWriter)
	{
		...
		p_Writer.Write((int) VehicleLightingMode);
		...
		p_Writer.Write(VehicleLightEnable);
