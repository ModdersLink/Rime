...
[ContainerType(8, 152)]
public class UISquadDeployMembersWidgetData
	: fb.VeniceShared.BFUIWidgetEntityData
{
	...
	public CtrRef<CustomOptionData> QuickmatchData { get; set; } = new();
	
	[ContainerField(0x88), JsonProperty(Order = 136)]
	public BFUIColorizationData BadSettings { get; set; } = new();
	...
	public override void Serialize(RimeWriter p_Writer, IEbxWriter p_EbxWriter)
	{
		...
		p_Writer.Write(p_EbxWriter.WriteImport(QuickmatchData));
		p_Writer.WriteNullBytes(4);
		BadSettings.Serialize(p_Writer, p_EbxWriter);
		p_Writer.WriteNullBytes(4);
	}
}
