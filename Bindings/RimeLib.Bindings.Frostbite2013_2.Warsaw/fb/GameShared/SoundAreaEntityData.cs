	...
	: fb.Entity.EntityData
{
	...
	public float FadeWidth { get; set; } = 10.000f;
	
	[ContainerField(0x2c), LayoutImmutable, Blittable, JsonProperty(Order = 44)]
	public float ProximityMultiplier { get; set; } = 1.000f;
	
	[ContainerField(0x30), LayoutImmutable, Blittable, JsonProperty(Order = 48)]
	public FadeCurveType FadeCurve { get; set; } = FadeCurveType.FadeCurveType_LinearDecibel;
