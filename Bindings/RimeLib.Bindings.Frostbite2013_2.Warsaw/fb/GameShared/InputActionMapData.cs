	...
	: fb.Core.DataContainer
{
	...
	public InputActionMapPlatform PlatformSpecific { get; set; } = InputActionMapPlatform.IAMPAllPlatforms;
	
	[ContainerField(0x1c), LayoutImmutable, Blittable, JsonProperty(Order = 28)]
	public InputActionMapSlot Slot { get; set; } = InputActionMapSlot.InputActionMapSlot_Root1;
