	...
	: fb.Entity.EntityData
{
	...
	public float BreakThreshold { get; set; } = 200.000f;
	...
	public bool EnableContinuousSimulation { get; set; } = false;
	...
	public override void Serialize(RimeWriter p_Writer, IEbxWriter p_EbxWriter)
	{
		...
		p_Writer.Write(Stabilized);
		p_Writer.Write(EnableContinuousSimulation);
