...
namespace fb
{
	...
	{
		[ContainerField(8)]
		public List<CtrRef<SendEntry>> Entries { get; set; } = new();

		public static void Deserialize(SendNodeData p_Instance, RimeReader p_Reader, IEbxParser p_Parser)
		{
			...
			{
				var s_CtrRef = new CtrRef<SendEntry>();
