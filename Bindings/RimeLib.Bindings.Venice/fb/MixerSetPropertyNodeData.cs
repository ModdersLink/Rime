...
namespace fb
{
	...
	{
		[ContainerField(8)]
		public List<CtrRef<MixerSetPropertyEntry>> Entries { get; set; } = new();

		public static void Deserialize(MixerSetPropertyNodeData p_Instance, RimeReader p_Reader, IEbxParser p_Parser)
		{
			...
			{
				var s_CtrRef = new CtrRef<MixerSetPropertyEntry>();
