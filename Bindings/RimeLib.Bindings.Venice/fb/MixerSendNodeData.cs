...
namespace fb
{
	...
	{
		[ContainerField(8)]
		public List<CtrRef<MixerSendEntry>> Entries { get; set; } = new();

		public static void Deserialize(MixerSendNodeData p_Instance, RimeReader p_Reader, IEbxParser p_Parser)
		{
			...
			{
				var s_CtrRef = new CtrRef<MixerSendEntry>();
