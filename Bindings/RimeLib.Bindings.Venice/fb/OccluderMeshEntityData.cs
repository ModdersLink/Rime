...
namespace fb
{
		...
		SpatialEntityData
	{
		...
		public CtrRef<RigidMeshAsset> Mesh { get { return m_Mesh; } set { if (OnPropertyChanging("OccluderMeshEntityData." + nameof(Mesh), this, m_Mesh, value)) m_Mesh = value; } } // 0x50 (80)
		...
		public override PropertyInfo GetFieldInfoByHash(uint p_Hash)
		{
			...
			{
				case 2088783990:
					return typeof(OccluderMeshEntityData).GetProperty(nameof(Mesh));
