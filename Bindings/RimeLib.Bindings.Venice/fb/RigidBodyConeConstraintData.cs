...
namespace fb
{
		...
		RigidBodyConstraintData
	{
		...
		public override PropertyInfo GetFieldInfoByHash(uint p_Hash)
		{
			...
			{
				case 3356124462:
					return typeof(RigidBodyConeConstraintData).GetProperty(nameof(MinAngle));

				case 1552731461:
					return typeof(RigidBodyConeConstraintData).GetProperty(nameof(AngularFriction));

				case 417488496:
					return typeof(RigidBodyConeConstraintData).GetProperty(nameof(MaxAngle));

				case 2421583705:
					return typeof(RigidBodyConeConstraintData).GetProperty(nameof(HasLimits));
