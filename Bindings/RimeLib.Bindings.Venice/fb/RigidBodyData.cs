...
namespace fb
{
		...
		DataContainer
	{
		...
		[ContainerField(32), MemberInfoFlag(137), ContainerFieldNameHash(2892215548)]
		...
		[ContainerField(40), LayoutImmutable, Blittable, MemberInfoFlag(49469), ContainerFieldNameHash(2298929185)]
		...
		[ContainerField(44), LayoutImmutable, Blittable, MemberInfoFlag(49469), ContainerFieldNameHash(306207591)]
		...
		[ContainerField(48), LayoutImmutable, Blittable, MemberInfoFlag(49469), ContainerFieldNameHash(2367237320)]
		...
		[ContainerField(52), LayoutImmutable, Blittable, MemberInfoFlag(49469), ContainerFieldNameHash(1004384727)]
		...
		[ContainerField(56), LayoutImmutable, Blittable, MemberInfoFlag(49421), ContainerFieldNameHash(92982954)]
		...
		[ContainerField(60), MemberInfoFlag(137), ContainerFieldNameHash(2158618691)]
		...
		[ContainerField(64), MemberInfoFlag(137), ContainerFieldNameHash(2856027376)]
		...
		[ContainerField(68), MemberInfoFlag(137), ContainerFieldNameHash(719540408)]
		...
		[ContainerField(72), MemberInfoFlag(53), ContainerFieldNameHash(2331402366), ContainerCtrRef]
		...
		[ContainerField(76), MemberInfoFlag(65), ContainerFieldNameHash(1187639635), ContainerRefArray]
