...
namespace fb
{
	...
	{
		[ContainerField(8)]
		public List<CtrRef<MixerOutputEntry>> Entries { get; set; } = new();

		public static void Deserialize(MixerOutputNodeData p_Instance, RimeReader p_Reader, IEbxParser p_Parser)
		{
			...
			{
				var s_CtrRef = new CtrRef<MixerOutputEntry>();
