...
namespace fb
{
	[ContainerType(4), MemberInfoFlag(53), ContainerSize(116), ContainerClass]
	public class FlatOutputNodeData : 
		OutputNodeData
	{
		protected float m_Angle = new float();
		[ContainerField(80), LayoutImmutable, Blittable, MemberInfoFlag(49469), ContainerFieldNameHash(205597860)]
		...
		[ContainerField(84), LayoutImmutable, Blittable, MemberInfoFlag(49469), ContainerFieldNameHash(622241232)]
		...
		[ContainerField(88), MemberInfoFlag(53), ContainerFieldNameHash(621526765), ContainerCtrRef]
		...
		[ContainerField(92), MemberInfoFlag(41), ContainerFieldNameHash(3914160568)]
		...
		[ContainerField(100), MemberInfoFlag(41), ContainerFieldNameHash(2374965052)]
		...
		[ContainerField(108), MemberInfoFlag(41), ContainerFieldNameHash(941445235)]
		...
		[ContainerField(111), MemberInfoFlag(41), ContainerFieldNameHash(823182532)]
