...
namespace fb
{
		...
		AudioGraphNodeData
	{
		...
		public AudioGraphNodePort In { get { return m_In; } set { if (OnPropertyChanging("LowPassFir64NodeData." + nameof(In), this, m_In, value)) m_In = value; } } // 0x8 (8)
		...
		public AudioGraphNodePort Frequency { get { return m_Frequency; } set { if (OnPropertyChanging("LowPassFir64NodeData." + nameof(Frequency), this, m_Frequency, value)) m_Frequency = value; } } // 0x10 (16)
		...
		public AudioGraphNodePort Out { get { return m_Out; } set { if (OnPropertyChanging("LowPassFir64NodeData." + nameof(Out), this, m_Out, value)) m_Out = value; } } // 0x18 (24)
		...
		public SoundGraphPluginRef Plugin { get { return m_Plugin; } set { if (OnPropertyChanging("LowPassFir64NodeData." + nameof(Plugin), this, m_Plugin, value)) m_Plugin = value; } } // 0x20 (32)
