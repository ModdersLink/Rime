...
namespace fb
{
		...
		SystemSettings
	{
		...
		public static void Deserialize(ServerSettings p_Instance, RimeReader p_Reader, IEbxParser p_Parser)
		{
			p_Instance.InstancePath = p_Parser.GetStringAtOffset(p_Reader.ReadUInt32());
			p_Instance.RemoteControlPort = p_Reader.ReadUInt32();
			p_Instance.DuplicationChance = p_Reader.ReadSingle();
			p_Instance.MaxQueriesPerSecond = p_Reader.ReadUInt32();
			p_Instance.CorruptionChance = p_Reader.ReadSingle();
			p_Instance.RemoteAdministrationPort = p_Parser.GetStringAtOffset(p_Reader.ReadUInt32());
			p_Instance.MaxDropDuration = p_Reader.ReadSingle();
			p_Instance.ReorderingChance = p_Reader.ReadSingle();
			p_Instance.HumanHealthMultiplier = p_Reader.ReadSingle();
			p_Instance.ServerName = p_Parser.GetStringAtOffset(p_Reader.ReadUInt32());
			p_Instance.MinDropDuration = p_Reader.ReadSingle();
			p_Instance.SaveGameVersion = p_Reader.ReadUInt32();
			...
			p_Instance.Playlist = p_Parser.GetStringAtOffset(p_Reader.ReadUInt32());
			p_Instance.SavePoint = p_Parser.GetStringAtOffset(p_Reader.ReadUInt32());
			p_Instance.IngameTimeout = p_Reader.ReadSingle();
			p_Instance.OutgoingFrequency = p_Reader.ReadSingle();
			p_Instance.RespawnTimeModifier = p_Reader.ReadSingle();
			p_Instance.MinLatency = p_Reader.ReadSingle();
			p_Instance.ServerPassword = p_Parser.GetStringAtOffset(p_Reader.ReadUInt32());
			p_Instance.TimeoutTime = p_Reader.ReadSingle();
			p_Instance.PlayerCountNeededForMultiplayer = p_Reader.ReadUInt32();
			p_Instance.VehicleSpawnDelayModifier = p_Reader.ReadSingle();
			p_Instance.DebugMenuClick = p_Parser.GetStringAtOffset(p_Reader.ReadUInt32());
			p_Instance.AdministrationPassword = p_Parser.GetStringAtOffset(p_Reader.ReadUInt32());
			p_Instance.LoadingTimeout = p_Reader.ReadSingle();
			p_Instance.DedicatedServerCpu = p_Reader.ReadInt32();
			p_Instance.DeathmatchDebugInfo = p_Reader.ReadBool();
			p_Instance.TimeoutGame = p_Reader.ReadBool();
			p_Instance.AILooksIntoCamera = p_Reader.ReadBool();
			p_Instance.IsStatsEnabled = p_Reader.ReadBool();
			p_Instance.IsTreeDestructionEnabled = p_Reader.ReadBool();
			p_Instance.HavokCaptureToFile = p_Reader.ReadBool();
			p_Instance.ShowTriggerDebugText = p_Reader.ReadBool();
			p_Instance.IsInternetSimulationEnabled = p_Reader.ReadBool();
			p_Instance.DisableCutscenes = p_Reader.ReadBool();
			p_Instance.JobEnable = p_Reader.ReadBool();
			p_Instance.ThreadingEnable = p_Reader.ReadBool();
			p_Instance.DrawActivePhysicsObjects = p_Reader.ReadBool();
			p_Instance.IsRanked = p_Reader.ReadBool();
			p_Instance.UnlockResolver = p_Reader.ReadBool();
			p_Instance.ScoringLogEnabled = p_Reader.ReadBool();
			p_Instance.HavokVisualDebugger = p_Reader.ReadBool();
			p_Instance.IsSoldierDetailedCollisionEnabled = p_Reader.ReadBool();
			p_Instance.LoadSavePoint = p_Reader.ReadBool();
			p_Instance.IsSoldierAnimationEnabled = p_Reader.ReadBool();
			p_Instance.IsAiEnabled = p_Reader.ReadBool();
			p_Instance.IsReconfigurable = p_Reader.ReadBool();
			p_Instance.IsDestructionEnabled = p_Reader.ReadBool();
			p_Instance.ForcePlaylist = p_Reader.ReadBool();
			p_Instance.IsNetworkStatsEnabled = p_Reader.ReadBool();
			p_Instance.AutoUnspawnBangers = p_Reader.ReadBool();
			p_Instance.RegulatedAIThrottle = p_Reader.ReadBool();
			p_Instance.EnableAnimationCulling = p_Reader.ReadBool();
			p_Instance.FallBackToSquadSpawn = p_Reader.ReadBool();
			p_Instance.AllowIndestructibleParts = p_Reader.ReadBool();
			p_Instance.IsPresenceEnabled = p_Reader.ReadBool();
			p_Instance.WaterPhysicsEnabled = p_Reader.ReadBool();
			p_Instance.RespawnOnDeathPosition = p_Reader.ReadBool();
			p_Instance.IsRenderDamageEvents = p_Reader.ReadBool();
			p_Instance.VehicleSpawnAllowed = p_Reader.ReadBool();
			p_Instance.QueryProviderEnabled = p_Reader.ReadBool();
			p_Instance.IsDesertingAllowed = p_Reader.ReadBool();
			p_Instance.DebrisClusterEnabled = p_Reader.ReadBool();
			p_Instance.AdministrationEnabled = p_Reader.ReadBool();
			p_Instance.AdministrationLogEnabled = p_Reader.ReadBool();
			p_Instance.AdministrationTimeStampLogNames = p_Reader.ReadBool();
			p_Instance.AdministrationEventsEnabled = p_Reader.ReadBool();
			p_Instance.AdministrationServerNameRestricted = p_Reader.ReadBool();
