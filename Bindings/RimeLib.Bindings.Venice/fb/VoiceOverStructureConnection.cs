...
namespace fb
{
		...
		DataContainer
	{
		...
		public static void Deserialize(VoiceOverStructureConnection p_Instance, RimeReader p_Reader, IEbxParser p_Parser)
		{
			p_Instance.TargetNode.SetValue(p_Parser.GetImportAtIndex(p_Reader.ReadUInt32()));
			p_Instance.TargetInput.SetValue(p_Parser.GetImportAtIndex(p_Reader.ReadUInt32()));
		}
