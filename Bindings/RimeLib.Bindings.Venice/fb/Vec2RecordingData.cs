...
namespace fb
{
		...
		PropertyRecordingData
	{
		...
		public static void Deserialize(Vec2RecordingData p_Instance, RimeReader p_Reader, IEbxParser p_Parser)
		{
			...
			for (uint i = 0; i < s_Values.Count; ++i)
			{
				...
				fb.Vec2.Deserialize(s_Value, s_Values.Reader, p_Parser);
