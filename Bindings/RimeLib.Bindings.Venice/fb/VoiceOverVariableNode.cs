...
namespace fb
{
		...
		VoiceOverExpressionNode
	{
		...
		[ContainerField(12)]
		public CtrRef<VoiceOverNamedValue> Source { get; set; } = new();

		public static void Deserialize(VoiceOverVariableNode p_Instance, RimeReader p_Reader, IEbxParser p_Parser)
		{
