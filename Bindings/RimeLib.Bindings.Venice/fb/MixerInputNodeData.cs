...
namespace fb
{
	...
	{
		[ContainerField(8)]
		public List<CtrRef<MixerInputEntry>> Entries { get; set; } = new();

		public static void Deserialize(MixerInputNodeData p_Instance, RimeReader p_Reader, IEbxParser p_Parser)
		{
			...
			{
				var s_CtrRef = new CtrRef<MixerInputEntry>();
