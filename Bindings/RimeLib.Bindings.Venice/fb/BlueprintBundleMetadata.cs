...
namespace fb
{
	...
	public class BlueprintBundleMetadata : 
		DataContainer
	{
		protected string m_BundlePathName = new string();
		[ContainerField(8), LayoutImmutable, ContainerFieldNameHash(852575899)]
		...
		[ContainerField(12), LayoutImmutable, ContainerFieldNameHash(461157046)]
		...
		protected string m_BlueprintName = new string();
		[ContainerField(16), LayoutImmutable, ContainerFieldNameHash(289256909)]
