...
namespace fb
{
		...
		UIItemDescription
	{
		...
		public static void Deserialize(UILevelDescription p_Instance, RimeReader p_Reader, IEbxParser p_Parser)
		{
			...
			p_Instance.ThumbnailTexturePath = p_Parser.GetStringAtOffset(p_Reader.ReadUInt32());
		}
