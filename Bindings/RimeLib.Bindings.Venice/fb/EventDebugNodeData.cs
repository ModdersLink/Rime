...
namespace fb
{
	...
	{
		[ContainerField(8)]
		public List<CtrRef<DebugEventInput>> Events { get; set; } = new();

		public static void Deserialize(EventDebugNodeData p_Instance, RimeReader p_Reader, IEbxParser p_Parser)
		{
			...
			{
				var s_CtrRef = new CtrRef<DebugEventInput>();
