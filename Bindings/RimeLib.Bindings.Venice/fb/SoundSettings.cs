...
namespace fb
{
	...
	public class SoundSettings : 
		SystemSettings
	{
		protected string m_VOEnglish = new string();
		[ContainerField(12), LayoutImmutable, ContainerFieldNameHash(433771118)]
		...
		protected string m_AudioSystemUri = new string();
		[ContainerField(16), LayoutImmutable, ContainerFieldNameHash(2343912184)]
		...
		protected string m_VOCommon = new string();
		[ContainerField(20), LayoutImmutable, ContainerFieldNameHash(2339452753)]
		...
		protected string m_VOItalian = new string();
		[ContainerField(24), LayoutImmutable, ContainerFieldNameHash(3307845866)]
		...
		protected string m_VOSpanish = new string();
		[ContainerField(28), LayoutImmutable, ContainerFieldNameHash(1980789858)]
		...
		protected string m_VOFrench = new string();
		[ContainerField(32), LayoutImmutable, ContainerFieldNameHash(2213601832)]
		...
		protected string m_VOGerman = new string();
		[ContainerField(36), LayoutImmutable, ContainerFieldNameHash(2207675566)]
		...
		[ContainerField(40), LayoutImmutable, Blittable, ContainerFieldNameHash(2342790116)]
