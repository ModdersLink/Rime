...
namespace fb
{
		...
		DataContainer
	{
		...
		[ContainerField(8), MemberInfoFlag(65), ContainerFieldNameHash(990812474), ContainerArray]
		...
		[ContainerField(12), MemberInfoFlag(65), ContainerFieldNameHash(3601242530), ContainerRefArray]
		...
		[ContainerField(16), MemberInfoFlag(65), ContainerFieldNameHash(2131743936), ContainerRefArray]
		...
		[ContainerField(20), MemberInfoFlag(65), ContainerFieldNameHash(2207841840), ContainerRefArray]
