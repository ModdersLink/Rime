...
namespace fb
{
	...
	{
		[ContainerField(Name: "TileIndexX", Offset: 0, NameHash: 2534612119, Flags: 49469), LayoutImmutable, Blittable]
		public float TileIndexX { get; set; } // 0x0 (0)
		
		[ContainerField(Name: "TileIndexY", Offset: 4, NameHash: 2534612118, Flags: 49469), LayoutImmutable, Blittable]
		public float TileIndexY { get; set; } // 0x4 (4)
		
		[ContainerField(Name: "TileCountX", Offset: 8, NameHash: 2473222698, Flags: 49469), LayoutImmutable, Blittable]
		public float TileCountX { get; set; } // 0x8 (8)
		
		[ContainerField(Name: "TileCountY", Offset: 12, NameHash: 2473222699, Flags: 49469), LayoutImmutable, Blittable]
