...
namespace fb
{
		...
		SpatialEntityData
	{
		...
		[ContainerField(Name: "Data", Offset: 80, NameHash: 2088730869, Flags: 41)]
		...
		public override PropertyInfo GetFieldInfoByHash(uint p_Hash)
		{
			...
			{
				case 2088730869:
					return typeof(GroundHeightEntityData).GetProperty(nameof(Data));
