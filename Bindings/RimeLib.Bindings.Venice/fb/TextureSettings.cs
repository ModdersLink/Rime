...
namespace fb
{
		...
		DataContainer
	{
		...
		public static void Deserialize(TextureSettings p_Instance, RimeReader p_Reader, IEbxParser p_Parser)
		{
			p_Instance.SkipMipmapCount = p_Reader.ReadUInt32();
			p_Instance.LoadingEnabled = p_Reader.ReadBool();
			p_Instance.RenderTexturesEnabled = p_Reader.ReadBool();
