...
namespace fb
{
		...
		AudioGraphNodeData
	{
		...
		[ContainerField(32)]
		public FrequencyShiftSsbFilter Filter { get; set; } = new();

		[ContainerField(36)]
		public SoundGraphPluginRef Plugin { get; set; } = new();

		public static void Deserialize(FrequencyShiftSsbNodeData p_Instance, RimeReader p_Reader, IEbxParser p_Parser)
		{
			...
			p_Instance.Filter = (FrequencyShiftSsbFilter) p_Reader.ReadInt32();
