...
namespace fb
{
		...
		UINodeData
	{
		...
		public override PropertyInfo GetFieldInfoByHash(uint p_Hash)
		{
			...
			{
				case 5862146:
					return typeof(RefreshNode).GetProperty(nameof(In));

				case 193453899:
					return typeof(RefreshNode).GetProperty(nameof(Out));

				case 3810860200:
					return typeof(RefreshNode).GetProperty(nameof(DataSource));
