...
namespace fb
{
		...
		EntityData
	{
		...
		public static void Deserialize(CompareIntEntityData p_Instance, RimeReader p_Reader, IEbxParser p_Parser)
		{
			p_Instance.Realm = (Realm) p_Reader.ReadInt32();
			p_Instance.A = p_Reader.ReadInt32();
			p_Instance.B = p_Reader.ReadInt32();
