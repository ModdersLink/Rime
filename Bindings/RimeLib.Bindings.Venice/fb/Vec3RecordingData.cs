...
namespace fb
{
	...
	{
		[ContainerField(12)]
		public List<Vec3> Values { get; set; } = new();

		public static void Deserialize(Vec3RecordingData p_Instance, RimeReader p_Reader, IEbxParser p_Parser)
		{
			...
			for (uint i = 0; i < s_Values.Count; ++i)
			{
				...
				fb.Vec3.Deserialize(s_Value, s_Values.Reader, p_Parser);
