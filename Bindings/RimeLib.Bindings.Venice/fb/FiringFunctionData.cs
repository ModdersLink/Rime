...
namespace fb
{
	[ContainerType(16), MemberInfoFlag(53), ContainerSize(496), ContainerClass]
	public class FiringFunctionData : 
		GameDataContainer
	{
		protected List<FiringDispersionData> m_Dispersion = new List<FiringDispersionData>();
		[ContainerField(8), MemberInfoFlag(65), ContainerFieldNameHash(1858542823), ContainerArray]
		...
		[ContainerField(12), MemberInfoFlag(41), ContainerFieldNameHash(1873092453)]
		...
		[ContainerField(80), MemberInfoFlag(65), ContainerFieldNameHash(3749424600), ContainerArray]
		...
		[ContainerField(84), MemberInfoFlag(65), ContainerFieldNameHash(3749424538), ContainerArray]
		...
		[ContainerField(88), MemberInfoFlag(53), ContainerFieldNameHash(231353798), ContainerCtrRef]
		...
		[ContainerField(96), MemberInfoFlag(41), ContainerFieldNameHash(2089430885)]
		...
		[ContainerField(192), MemberInfoFlag(41), ContainerFieldNameHash(1556251859)]
		...
		[ContainerField(344), MemberInfoFlag(41), ContainerFieldNameHash(2088639403)]
		...
		[ContainerField(384), MemberInfoFlag(41), ContainerFieldNameHash(3716934067)]
		...
		[ContainerField(480), LayoutImmutable, Blittable, MemberInfoFlag(49469), ContainerFieldNameHash(462585362)]
		...
		[ContainerField(484), LayoutImmutable, Blittable, MemberInfoFlag(49469), ContainerFieldNameHash(2347122798)]
		...
		[ContainerField(488), LayoutImmutable, Blittable, MemberInfoFlag(49325), ContainerFieldNameHash(2708726775)]
		...
		[ContainerField(489), LayoutImmutable, Blittable, MemberInfoFlag(49325), ContainerFieldNameHash(1249980612)]
