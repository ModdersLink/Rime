...
namespace fb
{
		...
		AudioGraphNodeData
	{
		...
		[ContainerField(24)]
		public AudioGraphNodePort AttackSpeed { get; set; } = new AudioGraphNodePort(); // 0x18 (24)
		
		[ContainerField(32)]
		public AudioGraphNodePort ReleaseSpeed { get; set; } = new AudioGraphNodePort(); // 0x20 (32)
