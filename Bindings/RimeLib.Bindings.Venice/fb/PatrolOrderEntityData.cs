...
namespace fb
{
		...
		BFOrderEntityData
	{
		...
		[ContainerField(40), MemberInfoFlag(137), ContainerFieldNameHash(2152665933)]
		...
		[ContainerField(44), MemberInfoFlag(137), ContainerFieldNameHash(3144829264)]
		...
		[ContainerField(48), MemberInfoFlag(53), ContainerFieldNameHash(3942738150), ContainerCtrRef]
		...
		[ContainerField(52), LayoutImmutable, Blittable, MemberInfoFlag(49325), ContainerFieldNameHash(4268018707)]
		...
		[ContainerField(53), LayoutImmutable, Blittable, MemberInfoFlag(49325), ContainerFieldNameHash(2941510446)]
