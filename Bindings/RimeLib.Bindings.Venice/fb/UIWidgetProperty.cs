...
namespace fb
{
	...
	public class UIWidgetProperty : FrostbiteContainer
	{
		...
		public override PropertyInfo GetFieldInfoByHash(uint p_Hash)
		{
			...
			{
				case 2088949890:
					return typeof(UIWidgetProperty).GetProperty(nameof(Name));

				case 225375086:
					return typeof(UIWidgetProperty).GetProperty(nameof(Value));
