...
namespace fb
{
		...
		VoiceOverConstantValue
	{
		...
		[ContainerField(Name: "Value", Offset: 8, NameHash: 225375086, Flags: 49325), LayoutImmutable, Blittable]
		...
		public override PropertyInfo GetFieldInfoByHash(uint p_Hash)
		{
			...
			{
				case 225375086:
					return typeof(VoiceOverConstantBooleanValue).GetProperty(nameof(Value));
