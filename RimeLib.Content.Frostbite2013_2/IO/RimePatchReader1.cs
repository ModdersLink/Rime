...
public class RimePatchReader1 : RimeReader
{
    ...
    public RimePatchEntryReader1? EntryReader { get; set; } = null;
    ...
    public RimePatchReader1(RimeReader p_BaseReader, RimeReader p_PatchReader, bool p_ShouldDispose = true)
        : this(p_BaseReader, p_PatchReader, p_BaseReader.Endianness)
    {
    }
    public RimePatchReader1(RimeReader p_BaseReader, RimeReader p_PatchReader, Endianness p_Endianness, bool p_ShouldDispose = true)
    ...
    private void ReadManifest()
    {
        ...
        EntryReader = new RimePatchEntryReader1(BaseReader, new LimitedRimeReader(PatchReader, PatchHeader.EntryPatchSize));
    }
