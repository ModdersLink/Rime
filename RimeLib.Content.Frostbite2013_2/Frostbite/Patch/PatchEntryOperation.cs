...
public class PatchEntryOperation  : IFbSerializable
{
	public uint OperationLength { get; set; }
	public PatchEntryOpType OperationType { get; set; }
	

	public PatchEntryOperation()
	{

	}

	public PatchEntryOperation(RimeReader p_Reader)
	{
	...
	{
		return $"EntryOp {OperationType} - 0x{OperationLength:x4}";
	}
	...
	public void Deserialize(RimeReader p_Reader)
	{
		...
		OperationLength = s_OpTypeSize & 0x0FFFFFFF;
		OperationType = (PatchEntryOpType)(s_OpTypeSize >> 28);
	}
	...
	public bool Serialize(RimeWriter p_Writer)
	{
		...
		s_OpTypeSize |= (OperationLength & 0x0FFFFFFF);
		s_OpTypeSize |= ((uint)OperationType << 28);
