    ...
    public static class FB2DDSImporter
    {
        public static void LoadDDS( RimeReader p_Reader, out TextureHeader p_Header, out Stream p_Data )
        {
                ...
                s_DDSHeader.m_PixelFormat.m_FourCC == DDSPixelFormat.s_DXExtFormat.m_FourCC ) //This is a dx texture
            {
                ...
                var s_TextureFormat = DDSUtils.s_DDSDXFormatMap.Where( x => x.Value == s_ExtendedHeader.m_DxgiFormat ).Select( x => x.Key ).FirstOrDefault( );
            ...
            else
            {
                ...
                foreach ( var s_FormatPair in DDSUtils.s_DDSFormatMap )
                {
                ...
                if ( ( s_DDSHeader.m_Caps & DDSCaps.Complex ) != 0 )
                    ...
                    p_Header.Type = ( s_DDSHeader.m_Height == 1 ) ? TextureType.TextureType_1D : TextureType.TextureType_2D; //if the height is 1, load as texture1d
