...
{
	[ContainerType(4, 40)]
	public partial class SimpleTransformNodeData :
		AudioGraphNodeData
	{
		[ObservableProperty]
		...
		private AudioGraphNodePort _Z = new();

		[ObservableProperty]
		[property: ContainerField(32), JsonProperty(Order = 32)]
		private SimpleTransformOperation _Operation = new();

		[ObservableProperty]
		[property: ContainerField(36), JsonProperty(Order = 36)]
		private AngleUnit _AngleUnit = new();
