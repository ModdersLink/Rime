...
{
	[ContainerType(4, 8)]
	public partial class GunMasterWeaponsPreset :
		EbxSerializable
	{
		[ObservableProperty]
		[property: ContainerField(0), JsonProperty(Order = 0)]
		private List<GunMasterLevelInfo> _GunMasterLevelInfos = new();
		
		[ObservableProperty]
		[property: ContainerField(4), JsonProperty(Order = 4)]
		private RefArray<CustomizeSoldierData> _LevelOverrides = new();
