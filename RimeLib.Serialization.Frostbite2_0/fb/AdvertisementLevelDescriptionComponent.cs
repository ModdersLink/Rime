...
{
	[ContainerType(4, 16)]
	public partial class AdvertisementLevelDescriptionComponent :
		LevelDescriptionComponent
	{
		...
		private List<AdvertisementZoneMember> _Members = new();
		...
		public override void Serialize(RimeWriter p_Writer, IEbxWriter p_EbxWriter)
		{
			...
			{
				s_Entry.Serialize(s_Members.Writer, p_EbxWriter);
			}
		}
	}
}
