...
{
	[ContainerType(4, 40)]
	public partial class EventGateNodeData :
		AudioGraphNodeData
	{
		[ObservableProperty]
		...
		private AudioGraphNodePort _CoolDownTime = new();

		[ObservableProperty]
		[property: ContainerField(32), JsonProperty(Order = 32)]
		private AudioGraphNodePort _Enable = new();
		...
		public override void Serialize(RimeWriter p_Writer, IEbxWriter p_EbxWriter)
		{
			...
			CoolDownTime.Serialize(p_Writer, p_EbxWriter);
