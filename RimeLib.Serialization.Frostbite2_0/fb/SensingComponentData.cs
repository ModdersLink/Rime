...
namespace fb
{
	...
	public partial class SensingComponentData :
		ComponentData
	{
		[ObservableProperty]
		[property: ContainerField(96), JsonProperty(Order = 96)]
		private CtrRef<SensingTemplateData> _Template = new();

		[ObservableProperty]
		[property: ContainerField(100), JsonProperty(Order = 100)]
		private CtrRef<SensingSettings> _Settings = new();
		...
		public override void Serialize(RimeWriter p_Writer, IEbxWriter p_EbxWriter)
		{
			...
			p_Writer.Write(SharedPlayerMemory);
			p_Writer.Write(UseWeaponTransform);
