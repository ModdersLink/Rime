...
{
	[ContainerType(4, 20)]
	public partial class UrgencyUserData :
		DataContainer
	{
		[ObservableProperty]
		[property: ContainerField(8), JsonProperty(Order = 8)]
		private CtrRef<UrgencyUserData> _Base = new();

		[ObservableProperty]
		[property: ContainerField(12), JsonProperty(Order = 12)]
		private List<UrgencyModifierData> _UrgencyModifiers = new();

		[ObservableProperty]
		[property: ContainerField(16), JsonProperty(Order = 16)]
		private RefArray<UrgencySetData> _ModifierSets = new();
