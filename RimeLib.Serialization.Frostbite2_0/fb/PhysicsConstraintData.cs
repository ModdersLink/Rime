...
{
	[ContainerType(16, 96)]
	public partial class PhysicsConstraintData :
		GameObjectData
	{
		[ObservableProperty]
		...
		private CtrRef<ReferenceObjectData> _ConstrainedObject = new();
		...
		public override void Serialize(RimeWriter p_Writer, IEbxWriter p_EbxWriter)
		{
			...
			p_Writer.Write(p_EbxWriter.WriteImport(ConstrainedObject));
