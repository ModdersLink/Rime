...
{
	[ContainerType(4, 20)]
	public partial class SurfaceShaderInstanceDataStruct :
		EbxSerializable
	{
		[ObservableProperty]
		...
		private List<BoolShaderParameter> _BoolParameters = new();
		
		[ObservableProperty]
		[property: ContainerField(8), JsonProperty(Order = 8)]
		private List<VectorShaderParameter> _VectorParameters = new();
		
		[ObservableProperty]
		[property: ContainerField(12), JsonProperty(Order = 12)]
		private List<VectorArrayShaderParameter> _VectorArrayParameters = new();
		
		[ObservableProperty]
		[property: ContainerField(16), JsonProperty(Order = 16)]
		private List<TextureShaderParameter> _TextureParameters = new();
