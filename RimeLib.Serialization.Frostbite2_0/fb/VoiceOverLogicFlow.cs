...
{
	[ContainerType(4, 24)]
	public partial class VoiceOverLogicFlow :
		DataContainer
	{
		[ObservableProperty]
		...
		private CtrRef<VoiceOverGroup> _Group = new();

		[ObservableProperty]
		[property: ContainerField(16), JsonProperty(Order = 16)]
		private RefArray<VoiceOverValue> _Locals = new();

		[ObservableProperty]
		[property: ContainerField(20), JsonProperty(Order = 20)]
		private RefArray<VoiceOverEventNode> _Roots = new();
