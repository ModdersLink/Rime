...
{
	[ContainerType(4, 12)]
	public partial class MeshVariationDatabaseMaterial :
		EbxSerializable
	{
		[ObservableProperty]
		[property: ContainerField(0), JsonProperty(Order = 0)]
		private CtrRef<MeshMaterial> _Material = new();
		
		[ObservableProperty]
		[property: ContainerField(4), JsonProperty(Order = 4)]
		private CtrRef<MeshMaterialVariation> _MaterialVariation = new();
