...
{
	[ContainerType(4, 24)]
	public partial class RichPresenceContext :
		DataContainer
	{
		[ObservableProperty]
		...
		private RefArray<RichPresenceContextValue> _Values = new();

		[ObservableProperty]
		[property: ContainerField(16), JsonProperty(Order = 16)]
		private CtrRef<RichPresenceContextValue> _DefaultValue = new();
