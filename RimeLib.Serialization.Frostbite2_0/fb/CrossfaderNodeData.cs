...
{
	[ContainerType(4, 48)]
	public partial class CrossfaderNodeData :
		AudioGraphNodeData
	{
		[ObservableProperty]
		[property: ContainerField(8), JsonProperty(Order = 8)]
		private AudioGraphNodePort _In1 = new();

		[ObservableProperty]
		[property: ContainerField(16), JsonProperty(Order = 16)]
		private AudioGraphNodePort _In2 = new();
		...
		private SoundGraphPluginRef _Plugin1 = new();

		[ObservableProperty]
		[property: ContainerField(43), JsonProperty(Order = 43)]
		private SoundGraphPluginRef _Plugin2 = new();
