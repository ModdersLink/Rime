...
{
	[ContainerType(4, 32)]
	public partial class WeaponOffsetData :
		DataContainer
	{
		[ObservableProperty]
		...
		private float _WeaponOffsetZ;

		[ObservableProperty]
		[property: ContainerField(20), LayoutImmutable, Blittable, JsonProperty(Order = 20)]
		private float _WeaponZoomedOffsetX;

		[ObservableProperty]
		[property: ContainerField(24), LayoutImmutable, Blittable, JsonProperty(Order = 24)]
		private float _WeaponZoomedOffsetY;

		[ObservableProperty]
		[property: ContainerField(28), LayoutImmutable, Blittable, JsonProperty(Order = 28)]
		private float _WeaponZoomedOffsetZ;
