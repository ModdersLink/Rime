...
namespace Rimelib.Ant.Frostbite2_0.Frostbite
{
    public class ReflectionAssetBank : AssetBank
    {
        ...
        public new void ParseData(RimeReader p_Reader, RimeLib.Ant.EA.GenericData.Data p_Data)
        {
        ...
        public new void ParseClass(RimeReader p_Reader, RimeLib.Ant.EA.GenericData.Data p_Data, long p_Offset = 0)
        {
