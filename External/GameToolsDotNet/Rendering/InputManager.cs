...
namespace GameToolsDotNet.Rendering.DirectX
{
    ...
    public class InputManager : IRenderable
    {
        ...
        public bool DrawFrame(RenderManager manager, params object[] args)
        {
            ...
            this.ButtonState[(int)InputAction.MoveForward] = this.KeyboardState[(int)Keys.W];
            this.ButtonState[(int)InputAction.MoveBackward] = this.KeyboardState[(int)Keys.S];
            this.ButtonState[(int)InputAction.StrafeLeft] = this.KeyboardState[(int)Keys.A];
            this.ButtonState[(int)InputAction.StrafeRight] = this.KeyboardState[(int)Keys.D];
            this.ButtonState[(int)InputAction.MoveUp] = this.KeyboardState[(int)Keys.X];
            this.ButtonState[(int)InputAction.MoveDown] = this.KeyboardState[(int)Keys.Z];
            this.ButtonState[(int)InputAction.CamSpeedIncrease] = this.KeyboardState[(int)Keys.Oemplus] || this.KeyboardState[(int)Keys.Add];
            this.ButtonState[(int)InputAction.CamSpeedDecrease] = this.KeyboardState[(int)Keys.OemMinus] || this.KeyboardState[(int)Keys.Subtract];
            this.ButtonState[(int)InputAction.NextAnimation] = this.KeyboardState[(int)Keys.PageUp];
            this.ButtonState[(int)InputAction.PreviousAnimation] = this.KeyboardState[(int)Keys.PageDown];
            this.ButtonState[(int)InputAction.MiscAction1] = this.KeyboardState[(int)Keys.D1] || this.KeyboardState[(int)Keys.NumPad1];
            this.ButtonState[(int)InputAction.MiscAction2] = this.KeyboardState[(int)Keys.D2] || this.KeyboardState[(int)Keys.NumPad2];
