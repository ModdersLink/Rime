...
namespace GameToolsDotNet.Rendering.DirectX.Shaders
{
    ...
    public abstract class Shader : IRenderable
    {
        ...
        public abstract bool InitializeGraphics(RenderManager manager, params object[] args);
        ...
        public virtual void DrawObjectPropertiesUI(RenderManager manager, object context = null)
        {

        }

        public virtual void CleanupGraphics(RenderManager manager, object context = null)
        {
