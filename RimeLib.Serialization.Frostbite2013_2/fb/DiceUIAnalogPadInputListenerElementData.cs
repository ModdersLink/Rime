...
public class DiceUIAnalogPadInputListenerElementData
	: fb.GameShared.UIElementEntityData
{
	[ContainerField(0xd0), LayoutImmutable, Blittable, JsonProperty(Order = 208)]
	public DiceUIAnalogPadType AnalogPadType { get; set; } = DiceUIAnalogPadType.DiceUIAnalogPadType_LeftStick;
	...
	public override void Serialize(RimeWriter p_Writer, IEbxWriter p_EbxWriter)
	{
		...
		p_Writer.Write((int) AnalogPadType);
