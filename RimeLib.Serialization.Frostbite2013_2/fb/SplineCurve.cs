	...
	: EbxSerializable
{
	...
	public Vec4 XValues0 { get; set; } = new()
	{
		w = 0.750f,
		z = 0.500f,
		y = 0.250f,
	...
	public Vec4 XValues1 { get; set; } = new()
	{
		w = 0.000f,
		z = 0.000f,
		y = 0.000f,
	...
	public Vec4 XValues2 { get; set; } = new()
	{
		w = 0.000f,
		z = 0.000f,
		y = 0.000f,
	...
	public Vec4 YValues0 { get; set; } = new()
	{
		w = 0.000f,
		z = 0.000f,
		y = 0.000f,
	...
	public Vec4 YValues1 { get; set; } = new()
	{
		w = 0.000f,
		z = 0.000f,
		y = 0.000f,
	...
	public Vec4 YValues2 { get; set; } = new()
	{
		w = 0.000f,
		z = 0.000f,
		y = 0.000f,
	...
	public Vec4 YValues3 { get; set; } = new()
	{
		w = 0.000f,
		z = 0.000f,
		y = 1.000f,
	...
	public Vec4 GValues0 { get; set; } = new()
	{
		w = 0.000f,
		z = 0.000f,
		y = 0.000f,
	...
	public Vec4 GValues1 { get; set; } = new()
	{
		w = 0.000f,
		z = 0.000f,
		y = 0.000f,
	...
	public Vec4 GValues2 { get; set; } = new()
	{
		w = 0.000f,
		z = 0.000f,
		y = 0.000f,
	...
	public Vec4 GValues3 { get; set; } = new()
	{
		w = 0.000f,
		z = 0.000f,
		y = 0.000f,
	...
	public Vec4 GValues4 { get; set; } = new()
	{
		w = 0.000f,
		z = 0.000f,
		y = 0.000f,
	...
	public Vec4 GValues5 { get; set; } = new()
	{
		w = 0.000f,
		z = 0.000f,
		y = 0.000f,
	...
	public SplineType SplineType { get; set; } = fb.Core.SplineType.SplineType_5ControlPoints;
