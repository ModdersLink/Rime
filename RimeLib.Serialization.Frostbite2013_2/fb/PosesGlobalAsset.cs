...
[ContainerType(8, 40)]
public class PosesGlobalAsset
	: fb.Entity.DataContainerPolicyAsset
{
	[ContainerField(0x18), JsonProperty(Order = 24)]
	public RefArray<PoseDefinition> Poses { get; set; } = new();
	
	[ContainerField(0x20), JsonProperty(Order = 32)]
	public CtrRef<PoseDefinition> DefaultPose { get; set; } = new();
	...
	public override void Serialize(RimeWriter p_Writer, IEbxWriter p_EbxWriter)
	{
		...
		p_Writer.Write(p_EbxWriter.WriteImport(DefaultPose));
		p_Writer.WriteNullBytes(4);
	}
}
