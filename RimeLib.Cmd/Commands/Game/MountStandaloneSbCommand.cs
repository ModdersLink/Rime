...
{
    [CommandDescription("Mounts the specified standalone superbundle from the filesystem.")]
    public class MountStandaloneSbCommand : Command
    {
        [CommandArgument(Description = "The name of the superbundle to mount.")]
        public string? Name { get; set; }

        [CommandArgument(Description = "The path to the superbundle (.sb file) on the filesystem.")]
        ...
        public override bool Execute(ref ExecutionContext p_Context, TextWriter p_Writer)
        {
            try
            {
                ...
                ((GameContext) p_Context).MountStandaloneSuperbundle(Name!, Path!.FullName, AutoMount);
